...
export { linkCoursetableToUser, fetchUserById, registerNewUser, addFavoriteCourse, patchUserInfo, deleteUserProfile, deleteUserAccount, request_otp_code, use_otp_link_student_id };
