...
import { Flex, Text, Button, IconButton, Badge, Tag, useToast, ScaleFade, TagLeftIcon, Spacer, useMediaQuery, HStack, Collapse, VStack } from '@chakra-ui/react';
        ...
        return (
            <Flex key={key} flexDirection="row" justifyContent="center" alignItems="center" h="100%" w="100%" py="2" px="2" bg="gray.100" my="1" borderRadius="lg" zIndex="1000">
                <Flex flexDirection="row" justifyContent="start" alignItems="center" h="100%" w="100%">
                    ...
                    <Text as={prepareToRemoveCourseId.includes(course._id) ? 'del' : ''} color={prepareToRemoveCourseId.includes(course._id) ? 'red.700' : 'gray.500'} fontSize="xl" fontWeight="bold">
                        {course.course_name}
                    </Text>
                    <IconButton
                        ml="2"
