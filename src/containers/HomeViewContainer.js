    ...
    return (
        <Box maxW="screen-md" mx="auto" overflow="visible" px="64px" pt="64px">
            ...
            <Flex justifyContent="space-between" mb={4} grow="1" flexDirection="column" alignItems="center">
                ...
                <HomeCard title="搜尋篩選功能，快速找到你要的課程 🚀" desc={['試著在空堂塞入課程，想看看禮拜一下午究竟還有哪些課？', '還是距離畢業還缺 A8 通識，想知道有哪些可以修呢 🤔', '讓我們的篩選功能，快速滿足你各式各樣的需求！']} img="https://imgur.com/jC8IUuw.gif" bg="gray.100"></HomeCard>
                <Spacer my={10} />
