import { HStack, Tag, Text, ButtonGroup, Button, Spacer, Icon, Flex, Image, useMediaQuery, VStack, Menu, MenuItem, MenuButton, MenuList, MenuDivider, useToast } from '@chakra-ui/react';
            ...
            return (
                <Flex h="95vh" pt="64px" justifyContent="center" alignItems="center">
                    <Flex flexDirection="column" justifyContent="center" alignItems="center">
                        ...
                        <HStack>
                            <Button variant="solid" onClick={() => window.open('https://www.surveycake.com/s/LzWd6', '_blank')}>
                                問題回報
                            </Button>
                            <Button variant="solid" colorScheme="teal" leftIcon={<FaHeartbeat />} onClick={() => window.open('https://status.course.myntu.me/', '_blank')}>
                                服務狀態
                            </Button>
                        </HStack>
                    </Flex>
            ...
            <>
                <Flex pt="64px" w="100%" justifyContent={'center'}>
                    <HStack my="2" mx="4%" spacing="4" w="100%" align="center">
                        ...
                        <Button key={'NolContent_Button_' + code + '_OpenNol'} size="md" rightIcon={<IoMdOpen />} onClick={() => window.open(genNolUrl(course), '_blank')}>
                            課程網資訊
                        </Button>
                        <CopyToClipboard text={'https://course.myntu.me/courseinfo/' + course._id}>
                            <Button
