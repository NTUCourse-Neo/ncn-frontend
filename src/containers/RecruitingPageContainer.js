    ...
    <Flex minH="95vh" direction="column" alignItems="center" px={["5", "20", "100", "200"]} pt="100px">
      ...
      <Flex my={4} w="100%" flexDirection={{ base: "column", lg: "row" }} justifyContent="space-between" alignItems="center" mt="20px">
        <Flex w="100%" direction="column" alignItems={{ base: "center", lg: "start" }} justifyContent="center">
          <Text as="h1" fontSize={{ base: "5xl", md: "7xl" }} fontWeight="bold" color="gray.700">
            We are hiring!
          </Text>
          <Text mt="-20px" ml="2" as="h1" fontSize="5xl" fontWeight="500" color="gray.500">
            新夥伴招募
          </Text>
          <Flex
            mt="8"
          ...
          >
            ...
            <Flex flexDirection="column" w="100%" alignItems="start">
              <Text fontSize="md" fontWeight="700" color="gray.500">
                In this role, you will...
              </Text>
              <Text fontSize="md" fontWeight="500" color="gray.500">
                - Co-develop the course selection service to enhance user experience.
              </Text>
              <Text fontSize="md" fontWeight="500" color="gray.500">
                - Work with innovative teammates.
              </Text>
              <Text fontSize="md" fontWeight="500" color="gray.500">
            ...
            <Flex flexDirection="column" mt="4" w="100%" alignItems="start">
              ...
              <Text fontSize="md" fontWeight="500" color="gray.500">
                - Familiar with React and Node.js development.
              </Text>
              <Text fontSize="md" fontWeight="500" color="gray.500">
                - Experience on Git.
              </Text>
              <Text fontSize="md" fontWeight="500" color="gray.500">
                - Experience on Docker and CI/CD tools is a plus.
              </Text>
            </Flex>
          </Flex>
        </Flex>
        <Flex my={4} w={{ base: "95%", md: "80%" }} direction="column" alignItems="end" justifyContent="center">
          <Flex w="100%" direction="column" alignItems="start" justifyContent="center">
            <Text my="4" fontSize={{ base: "xl", md: "3xl" }} fontWeight="600" color="gray.600">
              Join us @ NTUCourse Neo!
            </Text>
          </Flex>
          ...
          <InputGroup my="2" size="lg">
            <Input
              variant="outline"
              placeholder="電子郵件 / E-mail Address"
              onChange={(e) => {
          ...
          <Input
            ...
            my="2"
            variant="outline"
            placeholder="個人網站 / Personal Website"
            onChange={(e) => {
              setPersonalWebsite(e.currentTarget.value);
            }}
          />
          <Input
            size="lg"
            my="2"
            variant="outline"
            placeholder="簡歷、作品集網址 / CV or Portfolio Link"
            onChange={(e) => {
            ...
            >
              <HStack>
                ...
                <Popover placement="top-start">
                  <PopoverTrigger>
                    <Text as="button" color="blue.500" size="sm">
                      {" "}
                      <Text as="u">資料利用政策</Text>
                    </Text>
                  </PopoverTrigger>
                  <PopoverContent>
                    <PopoverArrow />
                    ...
                    <PopoverBody h={{ base: "300px", md: "500px" }} overflow="auto">
                      因應個人資料保護法及本團隊之個人資料管理規定，本團隊在向您蒐集個人資料之前，依法向您告知下列事項，當您勾選「我同意」，表示您已經閱讀、瞭解且同意接受下列之所有內容：
                      <br />
                      <br />
                      <Text fontWeight="800">1. 蒐集目的及類別</Text>
                      為提供團隊成員招聘需求及本團隊內部管理使用之蒐集目的，而須獲取您下列個人資料： 姓名、電話、E-mail
                      或其他得以直接或間接方式識別您個人之資料。 <br />
                      <br />
                      <Text fontWeight="800">2.個人資料利用之期間、地區、對象及方式</Text>
                      您的個人資料，除涉及國際業務或活動外，僅供本團隊及相關業務合作夥伴，於上述蒐集目的之必要合理範圍內加以利用至前述蒐集目的消失時為止。{" "}
                      <br />
                      <br />
                      ...
                      如您不提供或未提供正確之個人資料，或要求停止蒐集/處理/利用/刪除個人資料、服務訊息的取消訂閱，本團隊將無法為您提供蒐集目的之相關服務。{" "}
                      <br />
                      <br />
                      <Text fontWeight="800">5. 第三方服務供應商</Text>
                      本辦法僅列出本平台服務所需之資料運用相關條款，關於使用牽涉本平台之第三方服務之資料收集與管理辦法，請自行參閱各服務供應商之文件。除本規章外，若行為違反第三方服務之任何守則導致之相關後果，不在本伺服器管理範圍內，與本平台無涉。{" "}
                      <br />
                      <br />
                      <Text fontWeight="800">個人資料同意提供： </Text>
                      一、本人確已閱讀並瞭解上述告知事項，並勾選「我同意」授權貴團隊於所列目的之必要合理範圍內，蒐集、處理及利用本人之個人資料。{" "}
                      <br />
                      <br />
              ...
              <Button
                isDisabled={!isChecked || !isFilledRequiredFields() || !isCaptchaVerified}
