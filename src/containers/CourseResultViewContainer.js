                                            ...
                                            <Flex flexDirection="row">
                                                <Flex flexDirection="column" w="30%" px="4">
                                                    ...
                                                    <Switch size="lg" mr="2" onChange={ (e) => {
                                                      ...
                                                      <FilterModal title="未選擇課程時間" toggle={timeFilterOn} type="time" selectedDept={selectedDept} setSelectedDept={setSelectedDept}/>
                                                    </Flex>
                                                </Flex>
                                                <Flex flexDirection="column" w="30%" px="4">
                                                    <Flex flexDirection="row" alignItems="center" justifyContent="center">
                                                ...
                                                <Flex flexDirection="column" w="30%" px="4">
                                                    ...
                                                    <FilterModal title="未選擇課程類別" toggle={catFilterOn} type="category" selectedDept={selectedDept} setSelectedDept={setSelectedDept}/>
                                                    </Flex>
                                                </Flex>
