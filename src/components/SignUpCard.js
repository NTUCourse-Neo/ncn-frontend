    ...
    const renderReportPopover = () => {
        return (
            <Popover placement="bottom" isOpen={isOpen} onOpen={onOpen} onClose={onClose}>
                <PopoverTrigger>
                    <Button colorScheme="red" variant="ghost" size="sm" isDisabled={is_owner} isLoading={isReportingPost}>
                        檢舉
                    </Button>
                </PopoverTrigger>
                <PopoverContent>
                    ...
                    <Flex p="4" flexDirection="column" alignItems="start">
                        <Text fontSize="md" fontWeight="800" color="gray.700" textAlign="center">
                            檢舉此資訊
                        </Text>
                        <Textarea
                            my="2"
            ...
            <VStack mt={isMobile ? '4' : ''} w={isMobile ? '100%' : '70%'} h="100%">
                <VStack w="100%" h="100%" justify="start" align="start">
                    <HStack w="100%">
                        ...
                        {is_owner ? (
                            <Button size="sm" h="100%" variant={'ghost'} colorScheme="gray" fontSize={'sm'} color="red.600" onClick={() => handleDeletePost(post._id)} isLoading={isDeletingPost}>
                                刪除
                            </Button>
                        ) : (
                            <></>
                ...
                <HStack w="100%" justify="start">
                    ...
                    <Button
                        ...
                        onClick={() => handleVotePost(post._id, post.self_vote_status === 1 ? 0 : 1)}
                    >
                        {post.upvotes}
                    </Button>
                    <Button
